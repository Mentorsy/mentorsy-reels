...
1. It has to be licensed for commercial use. These tracks come from Pixabay,
   ...
   licence. Canva's library looks tempting and is not usable here: its popular
   music cannot be used as standalone audio outside Canva at all, and its Pro
...
2. It has to sit a long way down. These reels argue in typography; music that
   competes with the reading is worse than silence. The bed fades in over a
   second and out over two, and ducks further under a presenter's voice.
